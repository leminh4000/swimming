...
const StrockChart = ({activity})=>{
    ...
    for (let i=0; i<total_timer_times.length; i++) {
        ...
        console.log("strokesForMinute",strokesForMinute);
        strokesForMinutes.push(strokesForMinute);
    }
    console.log("total_timer_times",total_timer_times);
    console.log("strokesForLaps",strokesForLaps);
    console.log("strokesForMinutes",strokesForMinutes);
    return (
        <View>
